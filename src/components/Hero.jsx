  ...
  return (
    <div className="h-screen flex flex-col space-y-8 items-center justify-center text-center overflow-hidden ">
      ...
      <div className="z-20">
        ...
        <div className="pt-5">
          <a href="#about">
            <button className="border border-[#242424] text-gray-500 font-bold py-2 px-6 rounded-full text-sm uppercase tracking-widest transition-all hover:border-teal-500/40 hover:text-teal-500/40">
              About
            </button>
          </a>
